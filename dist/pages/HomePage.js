...
export function HomePage() {
    ...
    const handleCreatePost = (newPost) => {
        const post = Object.assign(Object.assign({ id: nextId }, newPost), { replies: 0, timestamp: 'Just now' });
        setPosts([post, ...posts]);
        setNextId(nextId + 1);
    };
    ...
    return (<div className="min-h-screen">
      ...
      <main className="container mx-auto p-4 max-w-5xl">
        ...
        {user && (<div className="win98-window mb-4">
            <div className="win98-titlebar">
              <span className="text-sm">Forum Controls</span>
            </div>
            <div className="p-2 flex gap-2">
              <button onClick={() => setShowCreateForm(true)} className="win98-button flex items-center gap-2 bg-[#00ff00]">
        ...
        <div className="win98-window">
          ...
          <div className="p-2">
            ...
            <div className="win98-panel min-h-[400px]">
              {filteredPosts.length === 0 ? (<div className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  {user && !searchQuery && (<button onClick={() => setShowCreateForm(true)} className="win98-button">
                      Create First Post
                    </button>)}
                </div>) : (<div>
      ...
      {showCreateForm && (<CreatePostForm onClose={() => setShowCreateForm(false)} onSubmit={handleCreatePost}/>)}
    </div>);
}
